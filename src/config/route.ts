import { HomeFilled, Box, ChatLineRound, User } from '@element-plus/icons-vue'
/** 路由配置 */
interface RouteSettings {
  /**
   * 是否开启动态路由功能？
   * 1. 开启后需要后端配合，在查询用户详情接口返回当前用户可以用来判断并加载动态路由的字段（该项目用的是角色 role 字段）
